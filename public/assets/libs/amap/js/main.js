(function() {
	...
	V.k = {
		...
		nq: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?lang=[lang]&size=1&scale=1&style=8&x=[x]&y=[y]&z=[z]",
		Mt: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?lang=zh_cn&size=1&style=7&x=[x]&y=[y]&z=[z]&scl=1&ltype=3",
		dB: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?style=6&x=[x]&y=[y]&z=[z]",
		mu: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scale=1&style=8",
		nu: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scl=1&style=8&ltype=11",
		Nq: "http://12.27.5.153/gaode/part/[z]/[x]/[y].png?lang=[lang]&size=1&style=7&x=[x]&y=[y]&z=[z]",

		// nq: "http://localhost:8081/appmaptile?lang=[lang]&size=1&scale=1&style=8&x=[x]&y=[y]&z=[z]",
		// Mt: "http://localhost:8081/appmaptile?lang=zh_cn&size=1&style=7&x=[x]&y=[y]&z=[z]&scl=1&ltype=3",
		// dB: "http://localhost:8081/appmaptile?style=6&x=[x]&y=[y]&z=[z]",
		// mu: "http://localhost:8081/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scale=1&style=8",
		// nu: "http://localhost:8081/appmaptile?x=[x]&y=[y]&z=[z]&lang=zh_cn&size=1&scl=1&style=8&ltype=11",
		// Nq: "http://localhost:8081/appmaptile?lang=[lang]&size=1&style=7&x=[x]&y=[y]&z=[z]",
